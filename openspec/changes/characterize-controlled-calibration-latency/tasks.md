...
- [ ] 4.1 Desplegar la instrumentación en `calibracion`; no tocar producción.
- [ ] 4.2 Ejecutar varias corridas sin `--diagnose`, cada una con archivo persistente nuevo bajo `/data/novaorders-policy`.
- [ ] 4.3 Revisar sólo agregados seguros, `eligibility` y persistencia.
- [ ] 4.4 Mantener `PRODUCT_RECOGNIZER_MODE=shadow`; no promover, sync, archive, commit ni push sin autoridad explícita.
