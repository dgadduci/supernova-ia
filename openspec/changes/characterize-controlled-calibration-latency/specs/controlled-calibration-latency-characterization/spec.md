# Capability: controlled-calibration-latency-characterization

## Purpose

Provide safe, stage-level aggregate latency evidence for controlled hybrid calibration reports, without altering recognition decisions, eligibility or runtime authority.
