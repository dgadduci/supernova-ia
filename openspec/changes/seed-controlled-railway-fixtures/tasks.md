...
- [ ] 4.1 After implementation approval and deployment, run verify-only once
  in Railway and retain sanitized statuses/counts only.
- [ ] 4.2 If and only if the target is confirmed empty and status is
...
- [ ] 5.1 Review the complete focused validation and sanitized Railway
  evidence.
