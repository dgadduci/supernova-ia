...
- [x] 3.1 Usuario ejecuta pytest focal, Ruff y compileall con `venv` y aporta salida.
- [x] 3.2 Ejecutar OpenSpec estricto y `git diff --check`.
- [x] 3.3 Tras aprobación/deploy: verify-only, apply, verify y resolución del manifiesto.
