# Capability: post-activation-recognition-monitoring

## Purpose

Provide a repeatable, privacy-safe and read-only procedure for observing
existing product-recognition events after hybrid-authoritative activation.
