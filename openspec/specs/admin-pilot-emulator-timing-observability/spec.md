# admin-pilot-emulator-timing-observability Specification

## Purpose
TBD - created by syncing change add-admin-pilot-emulator-timing-observability. Update Purpose after archive.
