# Capability: cliente-api

## Purpose

Define the HTTP API for managing clientes identified canonically by their normalized WhatsApp number, without a session relationship during the active subphase.
