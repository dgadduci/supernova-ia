# Capability: producto-api

## Purpose

Define the HTTP API and application-layer behavior for listing, retrieving, and creating products while preserving category and commerce ownership, normalization, scoped uniqueness, and transaction boundaries.
