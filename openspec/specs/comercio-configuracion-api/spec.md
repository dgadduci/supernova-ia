# Capability: comercio-configuracion-api

## Purpose

Define the read-only HTTP endpoint that returns a commerce's complete non-product configuration, including status, payment methods, and delivery methods.
