# post-4-12b-production-verification Specification

## Purpose
Define the minimum, privacy-safe and read-only gates for verifying the current
deployment state of authoritative hybrid product recognition. The capability
separates fresh operational evidence from historical promotion records and
prevents health or absent-observability signals from being treated as business
