# controlled-railway-calibration-identity Specification

## Purpose
TBD - created by archiving change align-frozen-calibration-dataset-with-controlled-railway-catalog. Update Purpose after archive.
## Requirements
