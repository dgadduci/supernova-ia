# Capability: seeds-producto-precios

## Purpose

Provide a runnable seed script that loads the canonical `producto-presentation → price` dataset into the target database, applying the category pricing policy and behaving idempotently across re-runs.
